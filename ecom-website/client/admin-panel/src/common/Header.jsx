...
<button aria-current="true" type="button" className="w-full px-4 py-1 font-semibold text-left rtl:text-right text-gray-100 bg-[#1F2937] border-b border-gray-200 rounded-t-lg cursor-pointer focus:outline-none ">
    ...
    <button onClick={()=>dispatch(logOut())} type="button" className="relative inline-flex items-center w-full px-4 py-1.5 text-sm font-medium border-b border-gray-200 rounded-t-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
