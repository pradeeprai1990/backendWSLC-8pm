...
function SignUpBox({ setCompStatus, compStatus, otpAfterSignUp, setotpAfterSignUp }) {
  //onClick={() => setotpAfterSignUp(true)}
  let apiBaseUrl=process.env.NEXT_PUBLIC_APIURL;
  ...
  let saveUser=(event)=>{
    ...
    axios.post(`${apiBaseUrl}web/user/sendotp`,obj)
    .then((res)=>{
        if(res.data.status){
  ...
  return (
    <>
      {otpAfterSignUp ? <OtpSignUp formDatavalue={formDatavalue}/> :
          ...
          <div className="flex flex-col gap-3 py-6">
            ...
            <div className="py-5 border-t border-gray-300">
              <div className="grid grid-cols-2 gap-5 mb-3">
                <input name="firstName" className="p-3 border text-[#757575] text-[14px] font-semibold border-[#757575] " type="text" placeholder="First Name" />
                <input  name="lastName" className="p-3 border text-[#757575] text-[14px] font-semibold border-[#757575] " type="text" placeholder="Last Name" />
              </div>
...
function OtpSignUp({formDatavalue}) {
  ...
  return (
    <div class="relative px-6 pt-10 pb-9  mx-auto w-full">
      <div class="mx-auto flex w-full max-w-md flex-col space-y-16">
        ...
        <div>
          <form onSubmit={checkOTPandSaveData}>
            <div class="flex flex-col space-y-10">
              <div class="flex flex-row items-center justify-between mx-auto w-full max-w-xs">
                <div class="w-100 h-16">
                  <input name="otp" required class="w-full h-full flex flex-col items-center justify-center bg-white text-center px-5 outline-none rounded-lg shadow-sm font-bold border-black text-lg  focus:bg-gray-50 focus:ring-1 ring-blue-700" max={4} type="text" id="" />
                </div>
